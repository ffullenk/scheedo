 ...
 * @method string                getTwitterUid()            Returns the current record's "twitter_uid" value
 ...
 * @method sfGuardUser           setFacebookUid()           Sets the current record's "facebook_uid" value
 * @method sfGuardUser           setTwitterUid()            Sets the current record's "twitter_uid" value
...
abstract class BasesfGuardUser extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('facebook_uid', 'integer', null, array(
             'type' => 'integer',
             ));
        $this->hasColumn('twitter_uid', 'string', 45, array(
             'type' => 'string',
             'length' => 45,
             ));
